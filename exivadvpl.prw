...
// Programa simples demonstrando o uso de operadores, mostrando alguma mensagem na tela

User Function exivadvpl()
    Local aArea := GetArea()
	
	//Declaração de variáveis
	Local nValor1	:= 5
	Local nValor2	:= 3
	Local cTexto1	:= "Gabriel Firmino"
	Local cTexto2	:= "Firmino"
